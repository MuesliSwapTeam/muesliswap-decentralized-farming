...
from muesliswap_onchain_staking.offchain.util import with_min_lovelace, sorted_utxos, adjust_for_wrong_fee
...
def main(
    ...
    context.submit_tx(
        adjust_for_wrong_fee(
           signed_tx, [payment_skey], fee_offset=100, output_offset=4_310
        )
    )
